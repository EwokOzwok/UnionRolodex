    ...
    f7Page(
      ...
      f7TabLayout(
        ...
        navbar = f7Navbar(
          ...
          title= "Union College Resource Rolodex"),
          ...
          f7Tab(
            ...
            f7Block(
              f7Shadow(
                intensity = 5,
                hover = TRUE,
                f7Card(title="Accessing Resources at Union College",
                       uiOutput("welcome"),
...
golem_add_external_resources <- function() {
  ...
  tags$head(
    ...
    HTML('<link rel="stylesheet" type="text/css" href="https://ewokozwok.github.io/myexternalresources/union-shinyMobile2.0.1.min.css">'),
