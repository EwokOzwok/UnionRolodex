...
# NEW WELCOME
    output$welcome <- renderUI({
      tagList(
        f7Accordion(id=NULL, multiCollapse = F,
                    ...
                    # Main Resource Rolodex Overview
                    f7AccordionItem(title = "Learn about the Resource Rolodex", open=F,
                                    f7Block(
                                      h3("The Resource Rolodex is your guide to discovering and accessing the wealth of services available to Union College students."),
                                      hr(),
                                      h4("Union College provides students with a variety of on- and off-campus resources to support academic success, personal growth, health, and well-being."),
                                      h4("Students are encouraged to take advantage of services across counseling, health, academic support, nutrition, and extracurricular engagement."),
                                      HTML('<center><img src="https://www.union.edu/sites/default/files/styles/hero/public/union-marketing-layer/202509/ivy-nott-wall-students_0.jpg?itok=v2r1rsRZ" width="80%"></center>'),
                                      f7Align(h6("Union College, located in Schenectady, NY, is committed to student success through a supportive and inclusive community."), side=c("center"))
                                    )
                    ),

                    # Health Services Overview
                    f7AccordionItem(title = "Health & Medical Services", open=F,
                                    f7Block(
                                      h3("Comprehensive Health Services"),
                                      hr(),
                                      h4("Union College students have access to a full range of health services including treatment for illnesses and injuries, immunizations, laboratory testing, and general wellness support."),
                                      h4("Students may also access telehealth options, psychiatric medication management, gender affirming care, nutrition counseling, and temporary medical equipment loans."),
                                      h4("These services are designed to ensure that students can maintain their health and well-being while pursuing their academic and personal goals.")
                                    )
                    ),

                    # Counseling & Mental Health
                    f7AccordionItem(title = "Counseling & Mental Health", open=F,
                                    f7Block(
                                      h3("Supporting Emotional and Social Well-Being"),
                                      hr(),
                                      h4("The Counseling Center provides therapy, consultation, and mental health support for all students."),
                                      h4("Services focus on personal growth, relationship-building, problem-solving, and promoting healthy lifestyle choices."),
                                      h4("Students may access in-person or telehealth sessions, crisis support, and specialized resources that respect diversity, equity, and inclusion.")
                                    )
                    ),

                    # Clubs, Organizations, and Campus Engagement
                    f7AccordionItem(title = "Student Life & Engagement", open=F,
                                    f7Block(
                                      h3("Clubs, Organizations, and Activities"),
                                      hr(),
                                      h4("Union College offers over 100 clubs and organizations spanning academic interests, cultural and identity groups, performing and visual arts, politics and activism, recreation, religious and spiritual groups, and more."),
                                      h4("All students are welcome to join these groups to explore interests, develop leadership skills, and connect with peers."),
                                      h4("Participation in student organizations is a valuable way to enrich your campus experience and foster personal growth.")
                                    )
                    ),

                    # Academic & Career Support
                    f7AccordionItem(title = "Academic & Career Resources", open=F,
                                    f7Block(
                                      h3("Supporting Success in School and Beyond"),
                                      hr(),
                                      h4("Students have access to academic advising, tutoring, and career services to help plan coursework, develop skills, and prepare for post-graduate opportunities."),
                                      h4("Union College emphasizes the holistic development of students, ensuring that support services address both academic and personal success.")
                                    )
                    )
  ...
  output$videos <- renderUI({
    tagList(
      f7Accordion(id=NULL, multiCollapse = F,
                  f7AccordionItem(title = "Union College: True to Our Name", open=F,
                                  f7Block(br(),
                                          f7Align(h3("More than a community, we're a union. Of the liberal arts and engineering. Of people with bright minds and courageous hearts. Of who you are and who you will become. We are Union."), side=c("center")),
                                          br(),
                                          HTML('<center><iframe width="auto" height="auto" src="https://www.youtube.com/embed/R8WknQi_yAo?si=HSKn4GdfAhjdmtQW" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe></center>'),
                                          br(),
                                          # hr()
                                  )
                  ),

                  f7AccordionItem(title = "A message from our President", open=F,
                                  f7Block(br(),
                                          f7Align(h3("A Message from President Elizabeth Kiss"), side=c("center")),
                                          br(),
                                          HTML('<center><iframe width="auto" height="auto" src="https://www.youtube.com/embed/LA0_JhiSWX8?si=rm95fdtr6GW5k2iq" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe></center>'),
                                          br(),
                                          # hr()
                                  )
                  ),

                  f7AccordionItem(title = "Union College Campus Tour", open=F,
                                  f7Block(br(),
                                          f7Align(h3("Take a trip around the Union College campus and learn more about life at Union."), side=c("center")),
                                          br(),
                                          HTML('<center><iframe width="auto" height="auto" src="https://www.youtube.com/embed/-K_OsgUzRHE?si=I9ytnejmr9m-8dg_" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe></center>'),
                                          br(),
                                          # hr()
                                  )
                  ),
